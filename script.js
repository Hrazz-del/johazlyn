...
yesBtn.addEventListener('click', () => {
    title.innerHTML = "YEAY YEAYY thankyouu sayangg lovee youu so much";
...
noBtn.addEventListener('click', () => {
    if (noCount < 3) {
        ...
        title.innerHTML = "TAPI BOONG HIHI";
